    ...
    <div className="tree-builder-page">
      ...
      <header className="tree-builder-nav">
        ...
        <div className="tree-builder-nav-center">
          <span className="tree-builder-project-name">{project.name}</span>
          {project.domain && <span className="tree-builder-domain">{project.domain}</span>}
          {project.testing_type && <span className="tree-builder-type">{project.testing_type}</span>}
        </div>
